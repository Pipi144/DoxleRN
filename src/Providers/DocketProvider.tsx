...
const DocketProvider = (children: any) => {
  ...
  const docketQuote: string = useMemo(
    () =>
      !navigationState
        ? ''
        : (navigationState.routes[navigationState.index].name as TDoxleMenu) === 'Projects'
        ...
        : (navigationState.routes[navigationState.index].name as TDoxleMenu) === 'Inbox'
        ...
        : (navigationState.routes[navigationState.index].name as TDoxleMenu) === 'Files'
        ? 'AAA'
        : '',
